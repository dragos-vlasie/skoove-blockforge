...
import PasswordSetupClient from "../../../src/cms/auth/PasswordSetupClient";

export const metadata: Metadata = {
  title: "Set up your BlockForge account",
    ...
    <main className="flex min-h-screen items-center justify-center bg-slate-50 px-5 py-12">
      <section className="w-full max-w-md rounded-3xl border border-slate-200 bg-white p-8 shadow-xl shadow-slate-200/60 sm:p-10">
        <div className="mb-8">
          ...
          <h1 className="text-3xl font-bold tracking-tight text-slate-950">Set up your account</h1>
          <p className="mt-3 leading-7 text-slate-600">
            Create a password to manage your website in BlockForge.
          </p>
        </div>

        {supabaseUrl && publishableKey ? (
          <PasswordSetupClient publishableKey={publishableKey} supabaseUrl={supabaseUrl} />
        ) : (
