...
import { retryClientDeployment } from "../../../../../../src/lib/cms/provisioning/retryClientDeployment";
...
export async function POST(
  ...
  try {
    ...
    const result = await retryClientDeployment({
      tenantId,
    ...
    return cmsAccessErrorResponse(error, "Unable to retry the client deployment.", 500);
  }
}
